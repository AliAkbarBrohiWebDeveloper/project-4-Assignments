...
def make_sentence(word,part_of_speach):
    if part_of_speach==0:
        ...
        print("part of speech must be 0,1,or 2 cannot make sentence")

def main():
    word:str=input("Please type a noun,verb,or adjective ")
    part_of_speach:int=int(input("Is this a noun, verb, or adjective? Type 0 for noun, 1 for verb, 2 for adjective: "))
