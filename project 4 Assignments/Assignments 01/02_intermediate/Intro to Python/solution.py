...
# Dictionary storing the percentage of Earth's gravity on each planet
gravity_constants = {
    "Mercury": 37.6,
    "Venus": 88.9,
    "Mars": 37.8,
...
# Function to calculate weight on another planet
def calculate_weight(earth_weight, planet):
    # Get the gravity constant for the selected planet
    gravity_percentage = gravity_constants.get(planet)
    
    if gravity_percentage is None:
...
def main():
    ...
    # Calculate and display the equivalent weight on the selected planet
